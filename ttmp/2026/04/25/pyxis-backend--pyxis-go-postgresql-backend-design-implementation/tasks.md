...
- [x] 11.1 Install `@bufbuild/protobuf` and configure `buf.gen.yaml` for TypeScript output
- [x] 11.2 Generate TypeScript bindings from existing `proto/pyxis/v1/show.proto`
