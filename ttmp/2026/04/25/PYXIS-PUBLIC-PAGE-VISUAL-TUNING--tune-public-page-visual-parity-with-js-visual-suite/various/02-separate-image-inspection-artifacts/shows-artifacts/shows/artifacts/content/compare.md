---
Title: Generated compare.region artifact for shows content
...
- Changed pixels: 838651/1599880 (52.4196%)
- Bounds changed: true
- Text changed: true
- Style changes: 9
- Attribute changes: 1
...
| padding-left | 32px | 0px |
| padding-right | 32px | 0px |
...
| --- | --- | --- |
| class |  | pyxis-public-page pyxis-shows-page |
