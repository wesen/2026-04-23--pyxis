...
- [ ] Build `PostShowLogEntryCard` with collapsed and expanded states.
- [ ] Build `PostShowLogSummary` and `PostShowLogToolbar`.
- [ ] Build `PostShowLogPanel` and Storybook stories for mixed, needs-log, logged, incident, empty, validation, desktop, and mobile states.
