(() => {
  ...
  root.append(
    ...
    row('Remaining standalone parts', [
      ...
      e('div', { 'data-comp': 'public-booking-space-aside-default', style: { width: '300px', background: '#1F1E1C', color: '#E8E3D8', padding: '26px', borderRadius: '6px', fontSize: '13px', lineHeight: '1.7', boxSizing: 'border-box' } }, e('div',{style:{fontFamily:"'Fraunces', serif",fontSize:'22px',fontWeight:'500',fontStyle:'italic',letterSpacing:'-.02em',marginBottom:'14px'}},'the space'), e('div',{style:{color:'#BCB7AD'}},'Capacity',e('br'),'150 standing · 80 seated',e('br'),'PA',e('br'),'Funktion-One F1201, 4-way')),
