...
SAMPLE_CFGS=(
  ...
  "$CONFIG_DIR/prototype-mobile-login.css-visual-diff.yml"
  "$CONFIG_DIR/prototype-mobile-home.css-visual-diff.yml"
  "$CONFIG_DIR/prototype-mobile-shows.css-visual-diff.yml"
  "$CONFIG_DIR/prototype-mobile-settings.css-visual-diff.yml"
)
