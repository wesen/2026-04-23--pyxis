...
type Querier interface {
	...
	GetShowLog(ctx context.Context, showID int32) (ShowLog, error)
	...
	ListShowLogs(ctx context.Context, arg ListShowLogsParams) ([]ListShowLogsRow, error)
	...
	UpsertShowLog(ctx context.Context, arg UpsertShowLogParams) (ShowLog, error)
