...
export function MetricCard({ label, value, caption, trend, tone = 'neutral' }: { label: string; value: string | number; caption?: string; trend?: string; tone?: 'neutral' | 'accent' | 'success' | 'warning' | 'info' }) {
