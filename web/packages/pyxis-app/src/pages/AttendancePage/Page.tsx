...
import type { AttendanceDraft } from '../../components/organisms/AttendancePanel/AttendancePanel';
...
export function AttendancePage() {
  ...
  const handleUpdateEntry = async (entry: NonNullable<typeof entries>[number], draft: AttendanceDraft) => {
    ...
    try {
      await updateAttendance({ showId: entry.showId, draw: draft.draw, notes: draft.notes, incident: draft.incident, incidentNotes: draft.incidentNotes }).unwrap();
