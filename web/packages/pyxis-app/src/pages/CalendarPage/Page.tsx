...
export function CalendarPage() {
  ...
  const initialCalendarShow = create(ShowSchema, { id: 0, artist: '', date: selectedDate, doorsTime: '8:00 PM', startTime: '9:00 PM', age: '21+', price: '', reserveTicketEnabled: false, genre: '', status: ShowStatus.CONFIRMED, capacity: 150, lineup: [] });
