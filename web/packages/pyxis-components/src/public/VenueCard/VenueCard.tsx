...
export const VenueCard = ({ address, capacity = 150, mapPlaceholder, className, 'data-part': dataPart }: VenueCardProps) => (
  <div data-part={dataPart ?? 'venue-card'} className={className} style={{ padding: '20px', background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: 'var(--radius-lg)' }}>
