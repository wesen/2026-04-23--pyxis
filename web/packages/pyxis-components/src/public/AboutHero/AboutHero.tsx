...
export const AboutHero = ({ tagline = 'A room where the weird shows happen.', className, 'data-part': dataPart }: AboutHeroProps) => (
  <div data-part={dataPart ?? 'about-hero'} className={className} style={{ padding: '48px 0 32px' }}>
