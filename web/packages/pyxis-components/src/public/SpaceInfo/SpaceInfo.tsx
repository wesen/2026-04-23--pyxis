...
export const SpaceInfo = ({ address, capacity = 150, email = 'info@pyxis.xyz', className, 'data-part': dataPart }: SpaceInfoProps) => (
  <div data-part={dataPart ?? 'space-info'} className={className} style={{ padding: '20px', background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: 'var(--radius-lg)' }}>
